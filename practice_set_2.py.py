...
'''Q3> Check the data type where the user gives input'''
# a = input("Enter any variation of number: ")
# ty = type(a)
# print(ty)

'''Q4> Using comparison operator to compare the values of two different variables'''
...
'''Q5> Find the average two numbers given by the user'''
# a = int(input("Enter the first number: "))
# b = int(input("Enter the second number: "))
# avg = (a+b)/2
# print("The average of the given two numbers are: ",avg)

'''Q6> Print the square of a number given by the user'''
